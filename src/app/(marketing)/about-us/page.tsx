        ...
        <Shell>
            ...
            <div className="mx-auto prose prose-quoteless prose-neutral dark:prose-invert">
                ...
                <section>
                    <h2>The Mission</h2>
                    <p>
                        Under Kaung&apos;s visionary leadership, Pure Cleaning
                        Newcastle transcended its origins as a mere cleaning
                        service, evolving into a catalyst for enhanced
                        lifestyles. By relieving individuals of the burdensome
                        task of household chores, Pure Cleaning Newcastle
                        strives to elevate the overall quality of life. Kaung
                        perceives his company not only as a business entity but
                        also as an indispensable cornerstone of the community.
                    </p>
                </section>
                <section>
                    <h2>The Future</h2>
                    <p>
                        Kaung&apos;s aspirations for Pure Cleaning Newcastle
                        reach far beyond traditional cleaning services. His goal
                        is to revolutionize customer satisfaction within the
                        industry, constantly adapting to meet the changing needs
                        of clients. While services may expand and diversify, the
